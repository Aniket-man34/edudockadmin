...
import { Bell, Search, Edit, Trash2, FileText, Megaphone, Wrench, Loader2, X, LogOut, Menu, ChevronLeft, ChevronRight } from 'lucide-react'
    ...
    <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-sm border-b border-slate-200 px-3 md:px-6 py-3 md:py-3.5">
      <div className="flex items-center justify-between gap-2 md:gap-4">
        ...
        <button
          type="button"
          onClick={onMenuClick}
          className="md:hidden p-2 rounded-lg text-gray-600 hover:bg-gray-100 min-h-[44px] min-w-[44px] flex items-center justify-center flex-shrink-0"
        ...
        <img src="/favicon.svg" alt="EduDock" className="hidden md:block h-8 w-8 mr-2 flex-shrink-0" />
        ...
        <div className="flex items-center gap-1 md:gap-4 ml-1 md:ml-4 flex-shrink-0">
          ...
          <Button
            ...
            className="text-gray-600 hover:text-red-600 min-h-[44px] min-w-[44px]"
            title="Logout"
          >
          ...
          <div className="flex items-center space-x-3">
            ...
            {/* Name/subtitle hidden on mobile to save space */}
